...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/LinkedIn-chetanr25-0077B5?style=flat-square&logo=linkedin&logoColor=0A66C2" alt="Total time coded since Oct 10 2024" />
  </a>
  <img src="https://komarev.com/ghpvc/?username=chetanr25&theme=tokyonight&color=F59E0B" alt="Profile views" />
  <a href="https://wakatime.com/@chetanr25">
    <img src="https://wakatime.com/badge/user/3b0327f2-aa69-4362-a1d9-116ee6d92e3a.svg" alt="Total time coded since Oct 10 2024" />
  </a>
...
class BackendEngineer:
    def __init__(self):
        self.name = "Chetan R"
        self.role = "Backend Engineer and cloud"
        self.current_work = "Oldowan Innovations"
        
    def build(self):
        return "Scalable APIs & Production Systems"
    
    def tech_stack(self):
        return ["Python", "FastAPI", "Django", "AWS", "Docker", "Flutter"]
    
    def philosophy(self):
        return "Clean architecture, system boundaries, and maintainable code"
```

I'm a backend-focused engineer who enjoys building reliable systems and working with production-grade codebases. Currently developing end-to-end backend systems and managing infrastructure using Python, FastAPI, Django, AWS, and Docker.

I also build cross-platform applications with **Flutter** and have shipped production-ready features across mobile and web.

**What drives me:** Clean architecture, system boundaries, and writing backend code that's easy to understand and extend.
...
- Winner at **Smart India Hackathon 2025** (MoE's Innovation Cell)
- **LiFT Scholarship** by Linux Foundation (top 500 globally)
- Won hackathons at **NITK Surathkal**, **PES University**, and **UVCE**
- Led **Aventus 3.0** – ranked #1 globally on Devfolio for 5 days
...
- LinkedIn: [linkedin.com/in/chetanr25](https://www.linkedin.com/in/chetanr25)
